...
# get_scenario_result / promote_scenario intentionally NOT defined here:
# the canonical implementations are imported from common.ml.clustering.scenario
# above. Local near-duplicates used to shadow them, silently dropping the
# durable-labels fallback, the tuning-profile stale marking, and the central
# MV refresh on the promote path.
