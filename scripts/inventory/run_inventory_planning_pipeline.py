...
STEPS = [
    {
        "id": "safety_stock",
        "label": "Safety Stock",
        "script": "scripts/inventory/compute_safety_stock.py",
        "args": [],
    ...
    },
    {
        ...
        "script": "scripts/inventory/compute_eoq.py",
        "args": [],
    ...
    },
    {
        ...
        "script": "scripts/inventory/compute_replenishment_plan.py",
        "args": [],
    ...
    },
    {
        ...
        "script": "scripts/inventory/generate_planned_orders.py",
        "args": [],
    ...
    },
    {
        "id": "exceptions",
        "label": "Exceptions",
        "script": "scripts/inventory/generate_replenishment_exceptions.py",
        "args": [],
