...
All paths relative to `mvp/demand/`. Use Glob/Grep to discover specific files.

---

## Commands

All run from `mvp/demand/`.
...
1. `mvp/demand/docs/ARCHITECTURE.md` — architecture, tables, data flow
2. `mvp/demand/docs/README.md` — stack, datasets, quick start
