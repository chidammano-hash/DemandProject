...
const MAX_CYCLES = (args && args.maxCycles) || 100
const DRY_STOP = (args && args.dryStop) || 2   // stop after this many consecutive cycles with no new P0/P1/P2
const START_CYCLE = (args && args.startCycle) || 2 // cycle 1 already done by hand
const ROOT = '/Users/manoharchidambaram/projects/DemandProject'
const UTI = `${ROOT}/usertestinputs`
...
Run EXACTLY:
  ...
  cd ${ROOT}/frontend && node ../usertestinputs/_harness/capture.mjs ${cycleDir}
