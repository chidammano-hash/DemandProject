...
| 35 | [Customer-Level Forecasting](02-forecasting/35-customer-level-forecasting.md) | **Implemented** — customer-only `customer_rule_router_v2` with eight fast statistical routes, frozen forward assignments, causal per-origin backtest routing, governed bottom-up item-location blending, and common-cohort gating |
