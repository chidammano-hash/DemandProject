...
| 35 | [Customer-Level Forecasting](02-forecasting/35-customer-level-forecasting.md) | **Implemented** — Croston/SBA customer forecasts, governed bottom-up item-location blending, and common-cohort backtest gating |
