...
| 35 | [Customer-Level Forecasting](02-forecasting/35-customer-level-forecasting.md) | **Implemented** — ordered `customer_rule_router` forecasts with frozen per-series routes, causal per-origin backtest routing, governed bottom-up item-location blending, and common-cohort gating |
