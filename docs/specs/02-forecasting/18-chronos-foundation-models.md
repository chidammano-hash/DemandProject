...
### Configuration (`config/algorithm_config.yaml`)
```yaml
chronos:
  enabled: true
  model_id: chronos
...
- `config/algorithm_config.yaml` — `algorithms.chronos`
...
- `config/algorithm_config.yaml` — `algorithms.chronos_bolt`
...
- `config/algorithm_config.yaml` — `algorithms.chronos2`
...
- `config/algorithm_config.yaml` — `algorithms.chronos2_enriched`
