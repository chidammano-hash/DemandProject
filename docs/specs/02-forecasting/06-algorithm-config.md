...
| **Key Files** | `config/forecasting/forecast_pipeline_config.yaml` (algorithms section), `scripts/run_backtest.py`, `scripts/run_backtest_catboost.py`, `scripts/run_backtest_xgboost.py` |
