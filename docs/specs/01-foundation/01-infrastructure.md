...
| Customer-Level Forecasting (generation-only, resumable parallel batches, GPU-auto Chronos + Croston fallback, six-month sales activity filter, 18 closed months → 18 future months) | [../02-forecasting/35-customer-level-forecasting.md](../02-forecasting/35-customer-level-forecasting.md) | Forecasting |
