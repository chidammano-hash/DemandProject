# PRD: AI Planner Forecast Value Add — 10-Month Walk-Forward Backtest
...
**Spec ID:** 02-27
**Related specs:** [01-ai-planning-agent](../06-ai-platform/01-ai-planning-agent.md) · [03-backtest-framework](../02-forecasting/03-backtest-framework.md) · [05-advanced-backtest](../02-forecasting/05-advanced-backtest.md) · existing FVA router [api/routers/forecasting/fva.py](../../../api/routers/forecasting/fva.py)
