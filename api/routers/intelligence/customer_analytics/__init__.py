...
This package combines six sub-routers (geo, segments, ranking, lifecycle,
kpis) into one ``router`` so ``api.main`` can mount it as a single unit.
"""
...
from . import geo, kpis, lifecycle, ranking, segments
