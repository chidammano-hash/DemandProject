...
CREATE INDEX IF NOT EXISTS idx_fact_sales_item_loc_startdate
  ON fact_sales_monthly (item_id, loc, startdate);
...
CREATE INDEX IF NOT EXISTS idx_fact_forecast_item_loc_startdate_fcstdate
  ON fact_external_forecast_monthly (item_id, loc, startdate, fcstdate);
...
CREATE INDEX IF NOT EXISTS idx_dim_sku_brand_desc_trgm
  ON dim_sku USING gin (brand_desc gin_trgm_ops);
...
CREATE INDEX IF NOT EXISTS idx_fact_forecast_item_id_trgm
  ON fact_external_forecast_monthly USING gin (item_id gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_fact_forecast_loc_trgm
  ON fact_external_forecast_monthly USING gin (loc gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_fact_forecast_customer_group_trgm
  ON fact_external_forecast_monthly USING gin (customer_group gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_fact_sales_item_id_trgm
  ON fact_sales_monthly USING gin (item_id gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_fact_sales_loc_trgm
  ON fact_sales_monthly USING gin (loc gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_fact_sales_customer_group_trgm
  ON fact_sales_monthly USING gin (customer_group gin_trgm_ops);
