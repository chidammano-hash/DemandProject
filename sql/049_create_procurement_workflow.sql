...
-- fact_purchase_orders: DS-generated POs (distinct from imported fact_open_purchase_orders)
...
CREATE TABLE IF NOT EXISTS fact_po_approval_log (
    ...
    po_line_id      BIGINT          REFERENCES fact_purchase_orders(po_line_id) ON DELETE CASCADE,
    po_number       VARCHAR(50)     NOT NULL,
