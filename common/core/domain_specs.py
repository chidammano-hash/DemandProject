...
ITEM_SPEC = DomainSpec(
    ...
    clean_file="staged/itemdata_clean.csv",
    source_columns={
        "item_id": "item_no",
    },
    search_fields=[
...
LOCATION_SPEC = DomainSpec(
    ...
    clean_file="staged/locationdata_clean.csv",
    search_fields=[
        "location_id",
        "site_id",
        "site_desc",
...
CUSTOMER_SPEC = DomainSpec(
    ...
    clean_file="staged/customerdata_clean.csv",
    search_fields=[
        "site",
        "customer_no",
        "customer_name",
...
TIME_SPEC = DomainSpec(
    ...
    clean_file="staged/timedata_clean.csv",
    search_fields=[
        "date_key",
        "day_name",
        "month_name",
...
DFU_SPEC = DomainSpec(
    ...
    source_file="dfu.txt",
    clean_file="staged/sku_clean.csv",
    search_fields=[
        "item_id",
        "loc",
        "brand",
...
SALES_SPEC = DomainSpec(
    ...
    clean_file="staged/sku_lvl2_hist_clean.csv",
...
INVENTORY_SPEC = DomainSpec(
    ...
    clean_file="staged/inventory_clean.csv",
...
SOURCING_SPEC = DomainSpec(
    ...
    clean_file="staged/sourcing_clean.csv",
...
PURCHASE_ORDER_SPEC = DomainSpec(
    ...
    clean_file="staged/purchase_orders_clean.csv",
