# common/medallion.py — backward-compatible shim
# Real implementation moved to common/engines/medallion.py
import sys as _sys
import types as _types
import common.engines.medallion as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.medallion.X", ...) also
    sets X on common.engines.medallion, where the actual functions
