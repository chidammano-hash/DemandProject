# common/job_state.py — backward-compatible shim
# Real implementation moved to common/services/job_state.py
import sys as _sys
import types as _types
import common.services.job_state as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.job_state.X", ...) also
    sets X on common.services.job_state, where the actual functions
