# common/exception_engine.py — backward-compatible shim
# Real implementation moved to common/engines/exception_engine.py
import sys as _sys
import types as _types
import common.engines.exception_engine as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.exception_engine.X", ...) also
    sets X on common.engines.exception_engine, where the actual functions
