# common/champion_strategies.py — backward-compatible shim
# Real implementation moved to common/ml/champion_strategies.py
import sys as _sys
import types as _types
import common.ml.champion_strategies as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.champion_strategies.X", ...) also
    sets X on common.ml.champion_strategies, where the actual functions
