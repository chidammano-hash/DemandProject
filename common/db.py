# common/db.py — backward-compatible shim
# Real implementation moved to common/core/db.py
import sys as _sys
import types as _types
import common.core.db as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.db.X", ...) also
    sets X on common.core.db, where the actual functions
