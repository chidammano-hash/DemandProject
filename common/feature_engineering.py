# common/feature_engineering.py — backward-compatible shim
# Real implementation moved to common/ml/feature_engineering.py
import sys as _sys
import types as _types
import common.ml.feature_engineering as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.feature_engineering.X", ...) also
    sets X on common.ml.feature_engineering, where the actual functions
