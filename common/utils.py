# common/utils.py — backward-compatible shim
# Real implementation moved to common/core/utils.py
import sys as _sys
import types as _types
import common.core.utils as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.utils.X", ...) also
    sets X on common.core.utils, where the actual functions
