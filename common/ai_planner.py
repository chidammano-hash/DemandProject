# common/ai_planner.py — backward-compatible shim
# Real implementation moved to common/ai/ai_planner.py
import sys as _sys
import types as _types
import common.ai.ai_planner as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.ai_planner.X", ...) also
    sets X on common.ai.ai_planner, where the actual functions
