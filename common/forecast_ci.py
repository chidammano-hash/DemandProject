# common/forecast_ci.py — backward-compatible shim
# Real implementation moved to common/ml/forecast_ci.py
import sys as _sys
import types as _types
import common.ml.forecast_ci as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.forecast_ci.X", ...) also
    sets X on common.ml.forecast_ci, where the actual functions
