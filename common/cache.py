# common/cache.py — backward-compatible shim
# Real implementation moved to common/services/cache.py
import sys as _sys
import types as _types
import common.services.cache as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.cache.X", ...) also
    sets X on common.services.cache, where the actual functions
