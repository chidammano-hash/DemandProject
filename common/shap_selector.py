# common/shap_selector.py — backward-compatible shim
# Real implementation moved to common/ml/shap_selector.py
import sys as _sys
import types as _types
import common.ml.shap_selector as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.shap_selector.X", ...) also
    sets X on common.ml.shap_selector, where the actual functions
