# common/planning_date.py — backward-compatible shim
# Real implementation moved to common/core/planning_date.py
import sys as _sys
import types as _types
import common.core.planning_date as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.planning_date.X", ...) also
    sets X on common.core.planning_date, where the actual functions
