# common/domain_specs.py — backward-compatible shim
# Real implementation moved to common/core/domain_specs.py
import sys as _sys
import types as _types
import common.core.domain_specs as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.domain_specs.X", ...) also
    sets X on common.core.domain_specs, where the actual functions
