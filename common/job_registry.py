# common/job_registry.py — backward-compatible shim
# Real implementation moved to common/services/job_registry.py
import sys as _sys
import types as _types
import common.services.job_registry as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.job_registry.X", ...) also
    sets X on common.services.job_registry, where the actual functions
