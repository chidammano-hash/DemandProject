# common/config_models.py — backward-compatible shim
# Real implementation moved to common/core/config_models.py
import sys as _sys
import types as _types
import common.core.config_models as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.config_models.X", ...) also
    sets X on common.core.config_models, where the actual functions
