# common/backtest_framework.py — backward-compatible shim
# Real implementation moved to common/ml/backtest_framework.py
import sys as _sys
import types as _types
import common.ml.backtest_framework as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.backtest_framework.X", ...) also
    sets X on common.ml.backtest_framework, where the actual functions
