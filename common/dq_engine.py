# common/dq_engine.py — backward-compatible shim
# Real implementation moved to common/engines/dq_engine.py
import sys as _sys
import types as _types
import common.engines.dq_engine as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.dq_engine.X", ...) also
    sets X on common.engines.dq_engine, where the actual functions
