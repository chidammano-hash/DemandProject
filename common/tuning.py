# common/tuning.py — backward-compatible shim
# Real implementation moved to common/ml/tuning.py
import sys as _sys
import types as _types
import common.ml.tuning as _real  # noqa: F401
...
class _ShimModule(_types.ModuleType):
    ...
    This ensures unittest.mock.patch("common.tuning.X", ...) also
    sets X on common.ml.tuning, where the actual functions
