...
help:  ## Auto-generated from `## ...` annotations on target lines
	...
	@echo "  tune-lgbm            - bounded exploratory LGBM tuning (targets <=5 minutes)"
	@echo "  tune-lgbm-full       - full 50-trial, 5-fold LGBM tuning"
...
forecast-snapshot-contenders:  ## Freeze and generate the three live-FVA contender forecasts
...
tune-lgbm: ## Bounded exploratory LGBM tuning (targets <=5 minutes)
	$(UV) python scripts/ml/tune_hyperparams.py --model lgbm --fast

tune-lgbm-full: ## Full 50-trial, 5-fold LGBM tuning for governed promotion
