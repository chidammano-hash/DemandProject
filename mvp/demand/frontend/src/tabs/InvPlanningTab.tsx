/**
 * IPfeature4 — EOQ & Cycle Stock Tab
 *
 * Inventory Planning tab: EOQ KPI cards, sensitivity line chart, and
 * paginated EOQ detail table.
 */
    ...
    <div className="flex flex-col gap-6 p-4">
      ...
      <div>
        <h2 className="text-xl font-semibold text-foreground">
          Inventory Planning — EOQ &amp; Cycle Stock
        </h2>
        <p className="text-sm text-muted-foreground mt-1">
          Economic Order Quantity targets per item-location, cycle stock, and total annual inventory cost.
        </p>
      </div>
