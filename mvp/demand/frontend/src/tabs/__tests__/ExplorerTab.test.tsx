...
vi.mock("@/api/queries", () => ({
  ...
  fetchDomains: vi.fn().mockResolvedValue({ domains: ["item", "location", "customer", "time", "dfu", "sales", "forecast"] }),
  fetchDomainMeta: vi.fn().mockResolvedValue({
    name: "item",
    plural: "items",
    default_sort: "item_no",
    columns: ["item_no", "item_desc", "brand_name"],
    numeric_fields: [],
    date_fields: [],
    category_fields: [],
  }),
  fetchDomainPage: vi.fn().mockResolvedValue({
    ...
    offset: 0,
    rows: [
      { item_ck: 1, item_no: "100320", item_desc: "Test Item", brand_name: "TestBrand" },
      { item_ck: 2, item_no: "100321", item_desc: "Another Item", brand_name: "OtherBrand" },
    ],
  }),
  ...
  fetchDfuClusters: vi.fn().mockResolvedValue({ domain: "dfu", total_assigned: 0, clusters: [] }),
  ...
  fetchDfuAnalysis: vi.fn().mockResolvedValue({ mode: "item_location", item: "", location: "", points: 0, models: [], series: [], model_monthly: {}, dfu_attributes: [] }),
