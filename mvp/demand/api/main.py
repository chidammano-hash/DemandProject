...
# ========================================================================
# Feature 37 — Inventory Planning Backtesting
# ========================================================================
...
@app.get("/inventory-backtest/summary")
def inv_backtest_summary(
    ...
    # excess threshold param used in the SQL
    ...
    # Rearrange params: threshold param needs to be first positional %s in SELECT
...
@app.get("/inventory-backtest/trend")
def inv_backtest_trend(
    ...
    # Group rows by month, nest by_model within each month
...
@app.get("/inventory-backtest/root-cause")
...
@app.get("/inventory-backtest/detail")
...
# ========================================================================
# Feature 36 — Dashboard & Distinct Values Endpoints
# ========================================================================
...
@app.get("/domains/{domain}/distinct")
def domain_distinct(
    domain: str,
    response: FastAPIResponse,
...
from api.routers import jobs as _jobs_router  # noqa: E402
